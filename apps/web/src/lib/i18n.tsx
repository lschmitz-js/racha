...
const dict = {
  en: {
    ...
    'checkin.guest': 'Guest',
    'checkin.noEmergency': 'No emergency contact',
    'checkin.missingEmergencyCount': '{n} confirmed still missing an emergency contact',
    ...
    'home.gameOnMonday': 'Game on this Monday.',
    'home.noGameMonday': 'No game this Monday.',
    'home.confirmedSoFar': '{n} confirmed so far',
    'home.noCheckinsYet': 'No check-ins yet',
    'home.headsUp': 'heads-up: no game {date} ({reason})',
    'home.nextRachaShort': 'Next racha: {date}',
    'home.prevMonth': 'Previous month',
    'home.nextMonth': 'Next month',
    'home.legendGame': 'Game',
    'home.legendNoGame': 'No game',
    'home.dayGameOn': 'Game on',
    'home.dayNoGame': 'No game',
    'home.cancelGame': 'Cancel a game',
    'home.cancelTitle': 'Cancel a game',
    'home.cancelHint': 'Call off a specific Monday. Everyone sees it here, and “Next racha” skips to the following game. Holidays are already off automatically.',
    'home.cancelWhich': 'Which game',
    'home.cancelReason': 'Reason (shown to everyone)',
    'home.cancelReasonPh': 'e.g. Gym unavailable',
    'home.cancelConfirm': 'Cancel this game',
    'home.keepGame': 'Keep game',
    'home.cancelNote': 'You can un-cancel any time.',
    'home.currentCancellations': 'Cancelled games',
    'home.unCancel': 'Un-cancel',
    'home.noUpcomingGames': 'No upcoming games to cancel.',
    ...
    'match.finishSession': 'Finish the night',
    'match.finishConfirm': "Finish tonight's session? This ends the night — no more matches can be added.",
    'match.undo': 'Undo',
    ...
    'match.half': 'Half {n}',
    'match.secondHalfIn': '2nd half in {n}s',
    'match.startSecondHalf': 'Start 2nd half',
    'match.staysL': 'stays',
  ...
  pt: {
    ...
    'checkin.noEmergency': 'Sem contato de emergência',
    'checkin.missingEmergencyCount': '{n} confirmados ainda sem contato de emergência',
    ...
    'home.gameOnMonday': 'Tem jogo nesta segunda.',
    'home.noGameMonday': 'Sem jogo nesta segunda.',
    'home.confirmedSoFar': '{n} confirmados até agora',
    'home.noCheckinsYet': 'Nenhum check-in ainda',
    'home.headsUp': 'atenção: sem jogo em {date} ({reason})',
    'home.nextRachaShort': 'Próximo racha: {date}',
    'home.prevMonth': 'Mês anterior',
    'home.nextMonth': 'Próximo mês',
    'home.legendGame': 'Jogo',
    'home.legendNoGame': 'Sem jogo',
    'home.dayGameOn': 'Tem jogo',
    'home.dayNoGame': 'Sem jogo',
    'home.cancelGame': 'Cancelar um jogo',
    'home.cancelTitle': 'Cancelar um jogo',
    'home.cancelHint': 'Cancele uma segunda específica. Todos veem aqui, e o “Próximo racha” pula para o jogo seguinte. Feriados já ficam de fora automaticamente.',
    'home.cancelWhich': 'Qual jogo',
    'home.cancelReason': 'Motivo (visível para todos)',
    'home.cancelReasonPh': 'ex.: Quadra indisponível',
    'home.cancelConfirm': 'Cancelar este jogo',
    'home.keepGame': 'Manter jogo',
    'home.cancelNote': 'Você pode desfazer o cancelamento quando quiser.',
    'home.currentCancellations': 'Jogos cancelados',
    'home.unCancel': 'Reativar',
    'home.noUpcomingGames': 'Nenhum jogo futuro para cancelar.',
    ...
    'match.finishSession': 'Encerrar a noite',
    'match.finishConfirm': 'Encerrar a sessão de hoje? Isso finaliza a noite — não dá para adicionar mais partidas.',
    'match.undo': 'Desfazer',
    ...
    'match.reopen': 'Reabrir',
    'match.rotateNow': 'Troque o reserva!',
    'match.half': '{n}º tempo',
    'match.secondHalfIn': '2º tempo em {n}s',
    'match.startSecondHalf': 'Começar 2º tempo',
    'match.staysL': 'fica',
    ...
    'recap.weeks': 'Sessões anteriores',
