...
const dict = {
  en: {
    ...
    'checkin.seasonOver': 'No game scheduled right now.',
    'checkin.whoAreYou': 'Who are you?',
    'checkin.pickName': 'Tap your name to check in for the next game.',
    'checkin.searchName': 'Search your name…',
    'checkin.notYou': 'Not you?',
    'checkin.change': 'Change',
    'checkin.imIn': "I'm in",
    'checkin.cantMake': "Can't make it",
    'checkin.youreIn': "You're in",
    'checkin.youreWait': 'Waitlist',
    'checkin.youreOut': 'Out',
    'checkin.confirmed': 'Confirmed',
    'checkin.waitlist': 'Waitlist',
    'checkin.out': "Can't make it",
    'checkin.awaiting': 'Season — not confirmed yet',
    'checkin.dropin': 'drop-in',
    'checkin.fullTeamsLine': '— full teams (15) —',
    'checkin.spotsLeft': '{n} spots left',
    'checkin.nobodyYet': 'Nobody has checked in yet.',
    'checkin.manage': 'Manage list (admin)',
    'checkin.clear': 'Clear',
    'checkin.all': 'All',
    ...
    'match.firstTie': 'First-game tie — pick who stays (odds or evens):',
    'match.startNextGame': 'Start next game',
    'match.nextStarted': 'The next game has already started.',
    'match.rotateNow': 'Rotate the sub!',
    'match.half': 'Half {n}',
    'match.staysL': 'stays',
    'match.comesOnL': 'comes on',
    'match.benchesL': 'benches',
    'match.overtime': 'overtime',
    'match.timesUp': "Time's up!",
    'match.dismiss': 'Dismiss',
    'match.prev': 'Previous match',
    'match.next': 'Next match',
    'match.deleteMatch': 'Delete match',
    'match.confirmDelete': 'Delete Match {n}? It has {e} recorded event(s). This can’t be undone.',
    'match.needFill': '{inVest} is short — add {n} from {outVest} (the team leaving) to make 5:',
    'match.stays': 'Stays',
    'match.sits': 'Sits',
    ...
    'recap.mvpAll': 'MVP all-time',
    'recap.scope.season': 'Season',
    'recap.scope.all': 'All-time',
    'recap.noStatsSeason': 'No games this season yet — try All-time.',
    ...
    // access (session code)
    'access.enterCode': "Enter today's code to help run the game:",
    'access.join': 'Join',
    'access.badCode': 'Wrong code',
    'access.adminSignIn': 'Admin sign in',
    'access.codeLabel': "Today's code",
    'access.codeShare': 'Share it with the people playing so they can help track.',
    ...
    'auth.recordLocked': 'No login needed to run the game — draw teams, run the clock, record stats. Sign in for organizer actions (close the session, delete, edit finished games):',
  ...
  pt: {
    ...
    // nav
    'nav.home': 'Início',
    'nav.checkin': 'Presença',
    'nav.players': 'Jogadores',
    'nav.recap': 'Estatísticas',
    'nav.rules': 'Regras',
    'checkin.title': 'Presença',
    'checkin.seasonOver': 'Nenhum jogo agendado no momento.',
    'checkin.whoAreYou': 'Quem é você?',
    'checkin.pickName': 'Toque no seu nome para confirmar presença no próximo jogo.',
    'checkin.searchName': 'Buscar seu nome…',
    'checkin.notYou': 'Não é você?',
    'checkin.change': 'Trocar',
    'checkin.imIn': 'Eu vou',
    'checkin.cantMake': 'Não vou',
    'checkin.youreIn': 'Confirmado',
    'checkin.youreWait': 'Lista de espera',
    'checkin.youreOut': 'Fora',
    'checkin.confirmed': 'Confirmados',
    'checkin.waitlist': 'Lista de espera',
    'checkin.out': 'Não vão',
    'checkin.awaiting': 'Fixos — ainda não confirmaram',
    'checkin.dropin': 'avulso',
    'checkin.fullTeamsLine': '— times completos (15) —',
    'checkin.spotsLeft': '{n} vagas restantes',
    'checkin.nobodyYet': 'Ninguém confirmou ainda.',
    'checkin.manage': 'Gerenciar lista (admin)',
    'checkin.clear': 'Limpar',
    'checkin.all': 'Todos',
    ...
    'match.firstTie': 'Empate no primeiro jogo — escolha quem fica (par ou ímpar):',
    'match.startNextGame': 'Começar próximo jogo',
    'match.nextStarted': 'O próximo jogo já começou.',
    'match.rotateNow': 'Troque o reserva!',
    'match.half': '{n}º tempo',
    'match.staysL': 'fica',
    'match.comesOnL': 'entra',
    'match.benchesL': 'senta',
    'match.overtime': 'acréscimo',
    'match.timesUp': 'Acabou o tempo!',
    'match.dismiss': 'Fechar',
    'match.prev': 'Jogo anterior',
    'match.next': 'Próximo jogo',
    'match.deleteMatch': 'Excluir jogo',
    'match.confirmDelete': 'Excluir o Jogo {n}? Ele tem {e} evento(s) registrado(s). Não dá pra desfazer.',
    'match.needFill': '{inVest} está incompleto — adicione {n} de {outVest} (o time que saiu) para formar 5:',
    'match.stays': 'Fica',
    'match.sits': 'Sai',
    ...
    'recap.mvpAll': 'Craque geral',
    'recap.scope.season': 'Temporada',
    'recap.scope.all': 'Geral',
    'recap.noStatsSeason': 'Nenhum jogo nesta temporada ainda — veja o Geral.',
    ...
    // access (código da sessão)
    'access.enterCode': 'Digite o código de hoje para ajudar no jogo:',
    'access.join': 'Entrar',
    'access.badCode': 'Código errado',
    'access.adminSignIn': 'Entrar como admin',
    'access.codeLabel': 'Código de hoje',
    'access.codeShare': 'Compartilhe com quem está jogando para ajudarem a registrar.',
    ...
    'auth.recordLocked': 'Sem login para tocar o jogo — sortear times, rodar o relógio, registrar estatísticas. Entre para ações de organizador (encerrar a sessão, excluir, editar jogos finalizados):',
